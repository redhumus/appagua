...
# V.0.0.1
    ...
    conectores = ['embargo','pueden','trabajo','tienen','puede','manera','partir','forma','investigación','dentro','mi','Desde','ello','Esta','Es','pues','toda','tenía','lado','Esto','le','les','vez','le','dos','debe','Sin','uno','ni','fue','sin','era','Para','cuales','Cuales','DE','Qué','ese','través','tanto','De','E','Así','esto','Se','cual','estas','más','.','esta','así','si','A','estos','Por','ante','son','cada','Nota','e','En','Y','tiene','El','en','cuando','sino','han','parte','sobre','porque','cómo','La','la','donde','sido','solo','desde','unos','hasta','entre','qué','ha','están','este','me','la','36','06','1','ya','está','0','es','eso','ahí','aquí','esa','o','no','entonces', 'también','va','como','allá','la', 'el','lo', 'de', 'con', 'y', 'a', 'en', 'por', 'que', 'los', 'las', 'un', 'una', 'del', 'al', 'para', 'se', 'su', 'sus', 'o', 'nos', 'aqui', 'pero']
